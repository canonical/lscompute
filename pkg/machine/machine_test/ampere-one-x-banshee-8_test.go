...
// AmpereOneXBanshee8 is the expected machine info for the "ampere-one-x-banshee-8" test fixture.
var AmpereOneXBanshee8 = register("ampere-one-x-banshee-8", machine.Machine{
	CPUs: []cpu.CPU{
		{
			Architecture:  "arm64",
			ImplementerId: 0xC0,
	...
	PCIDevices: []pci.PCIDevice{
		{
			...
			VendorId:    0x1DEF,
			DeviceId:    0xE208,
			SubvendorId: new(uint64(0x1DEF)),
			SubdeviceId: new(uint64(0xE100)),
		},
		{
			Bus:         "pci",
			Slot:        "0000:00:01.0",
		...
		},
		{
			...
			VendorId:    0x1A03,
			DeviceId:    0x1150,
			SubvendorId: new(uint64(0x1A03)),
			SubdeviceId: new(uint64(0x1150)),
		},
		{
			Bus:         "pci",
			Slot:        "0004:03:00.0",
