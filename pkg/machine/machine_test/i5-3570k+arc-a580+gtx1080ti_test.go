	...
	PCIDevices: []pci.PCIDevice{
		{
			...
			VendorId:    0x8086,
			DeviceId:    0x150,
			SubvendorId: new(uint64(0x1458)),
			SubdeviceId: new(uint64(0x5000)),
		},
		{
			Bus:         "pci",
			Slot:        "0000:00:01.0",
