...
// I710510U is the expected machine info for the "i7-10510U" test fixture.
var I710510U = register("i7-10510U", machine.Machine{
	CPUs: []cpu.CPU{
		{
			Architecture:   "amd64",
	...
	PCIDevices: []pci.PCIDevice{
		...
		},
		{
			...
			VendorId:    0x8086,
			DeviceId:    0x2723,
			SubvendorId: new(uint64(0x1A56)),
			SubdeviceId: new(uint64(0x1653)),
		},
		{
			Bus:         "pci",
			Slot:        "0000:03:00.0",
