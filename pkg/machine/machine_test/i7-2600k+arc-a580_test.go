...
var I72600kArcA580 = register("i7-2600k+arc-a580", machine.Machine{
	...
	PCIDevices: []pci.PCIDevice{
		...
		},
		{
			...
			VendorId:             0x8086,
			DeviceId:             0x56A2,
			SubvendorId:          new(uint64(0x1849)),
			SubdeviceId:          new(uint64(0x6003)),
		...
		},
		{
			...
			VendorId:    0x10B5,
			DeviceId:    0x8608,
			SubvendorId: new(uint64(0x10B5)),
			SubdeviceId: new(uint64(0x8608)),
		},
		{
			Bus:         "pci",
			Slot:        "0000:09:01.0",
		...
		},
		{
			...
			VendorId:    0x1B21,
			DeviceId:    0x1080,
			SubvendorId: new(uint64(0x1B21)),
			SubdeviceId: new(uint64(0x1080)),
		},
		{
			Bus:         "pci",
			Slot:        "0000:11:00.0",
