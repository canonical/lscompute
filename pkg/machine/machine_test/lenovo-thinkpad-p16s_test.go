	...
	PCIDevices: []pci.PCIDevice{
		{
			...
			VendorId:    0x1022,
			DeviceId:    0x1122,
			SubvendorId: new(uint64(0x17AA)),
			SubdeviceId: new(uint64(0x512E)),
		},
		{
			Bus:         "pci",
			Slot:        "0000:00:00.2",
		...
		},
		{
			...
			VendorId:    0x1022,
			DeviceId:    0x1125,
			SubvendorId: new(uint64(0x1022)),
			SubdeviceId: new(uint64(0x1125)),
		},
		{
			Bus:         "pci",
			Slot:        "0000:00:01.2",
